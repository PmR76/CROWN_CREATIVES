// ============================================================
// CoreLab Auto-Restore Engine — Safe Recovery of Core Runtime Files
// ============================================================
...
console.log("=== CORELAB AUTO-RESTORE START ===");
...
Object.entries(CORE_FILES).forEach(([quarantineName, originalPath]) => {
  ...
  if (fs.existsSync(quarantineFile)) {
    ...
    console.log(`⚪ Not found in quarantine: ${quarantineName}`);
  }
});
