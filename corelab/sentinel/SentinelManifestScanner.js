// ============================================================
// SentinelManifestScanner.js — Root Site Manifest Auditor (GR1)
// ============================================================
...
// ------------------------------------------------------------
// ROOT — Your live site is now at project root /public
// ------------------------------------------------------------
...
export function runSentinelManifestScanner() {
  try {
    ...
    const sounds = fs.existsSync(soundsPath)
      ? fs.readdirSync(soundsPath).filter(f => f.toLowerCase().endsWith(".mp3"))
      : [];
    ...
    console.error("Sentinel scanner failed:", err);
