/* ============================================================
   DOM READY WRAPPER
   Ensures ALL logic runs only after the iframe DOM is ready.
   ============================================================ */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function spawnParticle() {
    if (!particleField) return; // safety guard
  ...
  // Only start particles if the field exists
  if (particleField) {
  ...
  const frostCards = document.querySelectorAll(".frost-card");

  frostCards.forEach(card => {
  ...
  const adminButtons = document.querySelectorAll("#cards-admin button");
